#!/usr/bin/env sh
# Universal installer for enrichr. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/enrichr.git"
echo "Installing enrichr ..."
